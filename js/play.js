...
Game.Play.prototype = {
    ...
    create: function () {
        ...
        this.coinPosition = [];
        this.coinPosition[0] = [[150, h / 2], [w - 180, h / 2], [70, h - 100], [w - 70, h - 100]];
        this.coinPosition[1] = this.coinPosition[0].concat([[20, 100], [w - 80, 100]]);
    ...
    enemyWall: function (enemy, wall) {
        ...
        if (enemy.x < h / 2) {
            enemy.scale.setTo(-1, 1);
            enemy.x = 110 + enemy.width / 2 + 1;
        } else {
            enemy.scale.setTo(1, 1);
            enemy.x = w - 90 - enemy.width / 2 - 1;
        }
    },
    ...
    buildLevel: function () {
        ...
        bottom1.scale.setTo(15, 1);

        var bottom1bis = this.platforms.create(80, h - 20, 'brick');
        bottom1bis.anchor.setTo(0, 1);
        bottom1bis.scale.setTo(4, 1);

        var bottom2 = this.platforms.create(w / 2 + 50, h, 'brick');
        bottom2.anchor.setTo(0, 1);
        bottom2.scale.setTo(15, 1);

        var bottom2bis = this.platforms.create(w / 2 + 190, h - 20, 'brick');
